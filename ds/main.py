...
def main():
    ...
    url_dealerprice = 'http://0.0.0.0:8000/api/dealerprice/'
    df_dealerprice = prosept.preprocess_dealerprice(url_dealerprice)

    url_product = 'http://0.0.0.0:8000/api/product/'
    ...
    prosept.save_json('http://0.0.0.0:8000/api/recommendation/', json_result)
