...
def main():
    ...
    url_dealerprice = 'http://127.0.0.1:8000/api/dealerprice/'
    df_dealerprice = prosept.preprocess_dealerprice(url_dealerprice)

    url_product = 'http://127.0.0.1:8000/api/product/'
    ...
    prosept.save_json('http://127.0.0.1:8000/api/recommendation/', json_result)
